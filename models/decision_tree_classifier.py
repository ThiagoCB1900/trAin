...
def build_model(params: Dict[str, Any], random_state: int) -> DecisionTreeClassifier:
...
def get_spec() -> ModelSpec:
    return ModelSpec(
        ...
        params=[
            ParamSpec(name="criterion", label="Criterion", kind="choice", default="gini", choices=["gini", "entropy"]),
